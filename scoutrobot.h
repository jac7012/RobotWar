...
public:
    ScoutThirtyShotBot(const string& name, int startX, int startY, int w, int h)
...
public:
    ScoutSemiAutoBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
...
public:
    ScoutLongShotBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
...
public:
    ScoutJumpBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
...
public:
    ScoutHideBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
...
public:
    ScoutLongShotJumpBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          LongShotBot(name, startX, startY, w, h),
          JumpBot(name, startX, startY, w, h) {}
...
public:
    ScoutSemiAutoJumpBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          SemiAutoBot(name, startX, startY, w, h),
          JumpBot(name, startX, startY, w, h) {}
...
public:
    ScoutThirtyShotJumpBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          ThirtyShotBot(name, startX, startY, w, h),
          JumpBot(name, startX, startY, w, h) {}
...
public:
    ScoutLongShotHideBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          LongShotBot(name, startX, startY, w, h),
          HideBot(name, startX, startY, w, h) {}
...
public:
    ScoutSemiAutoHideBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          SemiAutoBot(name, startX, startY, w, h),
          HideBot(name, startX, startY, w, h) {}
...
public:
    ScoutThirtyShotHideBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          ThirtyShotBot(name, startX, startY, w, h),
          HideBot(name, startX, startY, w, h) {}
...
public:
    ScoutJumpLongShotBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          JumpBot(name, startX, startY, w, h),
          LongShotBot(name, startX, startY, w, h) {}
...
public:
    ScoutJumpSemiAutoBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          JumpBot(name, startX, startY, w, h),
          SemiAutoBot(name, startX, startY, w, h) {}
...
public:
    ScoutJumpThirtyShotBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          JumpBot(name, startX, startY, w, h),
          ThirtyShotBot(name, startX, startY, w, h) {}
...
public:
    ScoutHideLongShotBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          HideBot(name, startX, startY, w, h),
          LongShotBot(name, startX, startY, w, h) {}
...
public:
    ScoutHideSemiAutoBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          HideBot(name, startX, startY, w, h),
          SemiAutoBot(name, startX, startY, w, h) {}
...
public:
    ScoutHideThirtyShotBot(const string& name, int startX, int startY, int w, int h)
        : GenericRobot(name, startX, startY, w, h),
          ScoutBot(name, startX, startY, w, h),
          HideBot(name, startX, startY, w, h),
          ThirtyShotBot(name, startX, startY, w, h) {}
